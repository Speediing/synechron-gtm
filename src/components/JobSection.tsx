...
const JOB_ART: Record<JobId, string> = {
  "standardize-room": "/brand/synechron-watercolor-deck.png",
  "legal-redlines": "/brand/synechron-watercolor-reply.png",
  "attach-engine": "/brand/synechron-watercolor-brief.png",
};
